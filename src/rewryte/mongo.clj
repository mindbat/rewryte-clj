...
(defn save-results
  ...
  [account-id doc-name results-string results-map pages sentence-length]
  (let [doc-match {:account_id account-id :document_name doc-name}
        doc-update {:frequencies results-map :results results-string :pages pages :sentence_length sentence-length}]
